...
#### Лабораторные работы
**[Лабораторная работа 1: Анализ данных с расчетом статистических показателей и построением диаграмм](https://colab.research.google.com/drive/15yanfVSrg9h0WhE8FOZSz2oZFE0T38Ae?usp=sharing)**  
...
**[Лабораторная работа 6: Реализация алгоритма разложения чисел на множители методом Ферма с Cython и многопоточностью](https://github.com/danyakr/prog-lr-6)**  
